...
namespace Firebox {
	...
	class FIREBOX_API Shader : public RefCounted
	{
	public:
		...
		virtual void SetMat3(const String& name, const Mat3x3& matrix) = 0;
		virtual void SetMat4(const String& name, const Mat4x4& matrix) = 0;
