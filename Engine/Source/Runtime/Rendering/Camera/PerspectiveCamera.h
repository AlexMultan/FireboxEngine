...
namespace Firebox {
	...
	public:
		...
		virtual Mat4x4 GetPerspective() const override;
		virtual Mat4x4 GetPerspectiveInfinite() const override;
		Mat4x4 ReversePerspective(float fovY, float aspect, float zNear, float zFar) const;
		Mat4x4 ReversePerspectiveInfinite(float fovY, float aspect, float zNear) const;
