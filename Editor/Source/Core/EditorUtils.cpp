...
{
	s_MeshIconTexture = Firebox::Texture::Create(FireboxEditor::Paths::Resource("Icons/T_MeshIcon.png").string())->GetTextureID();
	s_DirectoryIcon = Firebox::Texture::Create(FireboxEditor::Paths::Resource("Icons/T_DirectoryIcon.png").string())->GetTextureID();
	s_FileIcon = Firebox::Texture::Create(FireboxEditor::Paths::Resource("Icons/T_FileIcon.png").string())->GetTextureID();
