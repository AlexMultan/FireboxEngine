...
- **Entity Component System** - Built on top of [EnTT](https://github.com/skypjack/entt) with a UUID-based entity identity system and core components: `Transform`, `Tag`, `Mesh`, `Material`, `Id` and `StaticMesh`
